 ...
 */
export const DEFAULT_MODEL = "Claude Opus 4.6 (Thinking)";
// ─────────────────────────────────────────────
// Encoding Functions
// ─────────────────────────────────────────────
/**
 ...
 * ```
 */
export function ldField(tag, data) {
 ...
 * @returns Framed data
 */
export function frame(data, isEndOfStream = false) {
 ...
 */
export function buildMetadata(oauthToken, extensionVersion = "1.14.2") {
 ...
 * ```
 */
export function buildSafetyConfig(modelName) {
