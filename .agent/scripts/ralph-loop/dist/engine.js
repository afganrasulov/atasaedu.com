 ...
 * ```
 */
export function generateDoneMarker(loopId) {
 ...
 */
export function isDoneMarkerPresent(progressFilePath, doneMarker) {
    try {
 ...
 */
export function buildPrompt(config, loopId, promptContent) {
 ...
 * @param config - Loop konfigürasyonu
 */
export async function runLoop(client, config) {
