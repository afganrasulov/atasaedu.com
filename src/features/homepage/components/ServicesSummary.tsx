...
export function ServicesSummary() {
    ...
    const services = [
        { title: t("culturalRichness"), description: t("culturalRichnessDesc"), icon: Globe },
        { title: t("qualityEducation"), description: t("qualityEducationDesc"), icon: GraduationCap },
        { title: t("economicOpportunities"), description: t("economicOpportunitiesDesc"), icon: Landmark },
        { title: t("easyAccess"), description: t("easyAccessDesc"), icon: CheckCircle }
    ];
                ...
                <div className="flex flex-col lg:flex-row items-center gap-20 lg:gap-28">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-[#0047BB] font-black uppercase tracking-[0.2em] text-[10px]">{t("badge")}</span>
                        </motion.div>

                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-[#152239] leading-[1.1] mb-8">
                            {t.rich("title", {
                                highlight: () => <span className="text-[#0047BB]">{t("highlight")}</span>,
                            })}
                        </h2>
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    <div className="text-left">
                                        ...
                                        <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{t("registeredStudents")}</div>
                                    </div>
                                    <div className="w-[1px] h-8 bg-slate-200" />
                                    <div className="text-right">
                                        <div className="text-2xl font-black text-[#0047BB]">%100</div>
                                        <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{t("acceptanceGuarantee")}</div>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        >
                            <span className="relative z-10 flex items-center gap-3">
                                {t("freeConsultation")} <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </span>
