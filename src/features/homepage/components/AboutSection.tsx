...
export function AboutSection() {
    ...
    const benefits = [
        { text: t("benefit1"), icon: GraduationCap },
        { text: t("benefit2"), icon: Globe },
        { text: t("benefit3"), icon: Users },
        { text: t("benefit4"), icon: MapPin }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 font-semibold text-sm mt-1">{t("happyStudents")}</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        <div className="inline-flex items-center gap-3 mb-6">
                            ...
                            <span className="text-blue-600 font-extrabold uppercase tracking-[0.2em] text-sm">{t("badge")}</span>
                        </div>

                        <h2 className="text-4xl md:text-6xl font-black text-[#152239] leading-[1.1] mb-8 tracking-tighter">
                            {t.rich("title", {
                                brand: () => <span className="text-blue-600">Atasa</span>,
                            })}
                        </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 mb-12">
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-gray-800 font-bold text-sm leading-tight">{benefit.text}</span>
                                </motion.div>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-sm font-bold text-gray-500 italic">
                                    <span className="text-blue-600">+1200</span> {t("appliedCount")}
                                </p>
                            </div>
                        </div>
                    </motion.div>
