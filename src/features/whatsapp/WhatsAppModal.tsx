...
Yardımcı olabilir misiniz?`;
    ...
    const inputStyle =
        "w-full bg-slate-50 border-2 border-slate-300 rounded-xl px-4 h-14 text-lg text-slate-900 placeholder-slate-400 focus:ring-4 focus:ring-green-100 focus:border-green-500 outline-none transition-all font-medium";
    const labelStyle =
        "block text-lg font-bold text-slate-800 mb-2 flex items-center gap-2";
                        ...
                        <div className="p-6 md:p-8 space-y-6">
                            ...
                            <div className="space-y-4 bg-slate-50 p-4 rounded-2xl border border-slate-200">
                                <div className="relative">
                                    ...
                                    <ChevronDown
                                        className="absolute right-4 top-[50px] text-slate-500 pointer-events-none"
                                        size={28}
                                    />
                                </div>
